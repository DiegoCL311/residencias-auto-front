...
const rows = [
  {
    ...
    id: "seguimientoAExternoAsistencia",
    valor: 5,
  },
  {
    criterio: "Demuestra conocimiento en el área de su especialidad",
    id: "seguimientoAExternoConocimiento",
    valor: 10,
  },
  {
    criterio: "Trabajo en equipo y se comunica de forma efectiva (oral y escrita)",
    id: "seguimientoAExternoEquipo",
    valor: 5,
  },
  {
    criterio: "Propone mejoras al Es dedicado y proactivo en las actividades encomendadas",
    id: "seguimientoAExternoMejoras",
    valor: 10,
  },
  {
    criterio: "Es ordenado y cumple satisfactoriamente con las actividades encomendadas en los tiempos del cronograma.",
    id: "seguimientoAExternoOrdenado",
    valor: 15,
  },
  {
...
export function FormSeguimientoAsesorExterno() {
